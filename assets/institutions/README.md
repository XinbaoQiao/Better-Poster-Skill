...
assets/institutions/current-institution.txt
```
...
- The resolver only matches institutions configured in `data/csrankings_top100_institutions.json`.
- On a cache hit, it copies `assets/institutions/cache/<institution-slug>.png` to `assets/institutions/current-logo.png`.
