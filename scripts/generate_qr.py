...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--scan-icons-dir", "--phone-icons-dir", dest="phone_icons_dir", default="assets/icons", help="Directory with QR/scan PNG icons used by --scan-icon auto.")
    parser.add_argument("--scan-icon-prefix", "--phone-icon-prefix", dest="phone_icon_prefix", default="../assets/icons", help="Path prefix written into the LaTeX snippet for auto-selected QR/scan icons.")
